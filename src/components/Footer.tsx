      ...
      <div className="py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Subscribe to receive seasonal updates, exclusive offers, and inspiration 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-2">
              <h4 className="text-2xl font-bold mb-4 text-foreground">Serenity Camp</h4>
              <p className="text-muted-foreground mb-6 max-w-md">
                Where luxury meets wilderness. Experience the perfect blend of comfort 
                and adventure in nature's most beautiful settings.
              </p>
            ...
            <div>
              ...
              <div className="space-y-3 text-muted-foreground">
                <div className="flex items-start gap-3">
                  ...
                  <span>123 Serenity Valley Road<br />Pine Ridge, MT 59718</span>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-muted-foreground text-sm">
              © 2024 Serenity Camp. All rights reserved.
            </div>
