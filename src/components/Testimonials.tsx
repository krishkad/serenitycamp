...
const testimonials = [
  {
    ...
    rating: 5,
    quote: "The perfect blend of luxury and nature. We disconnected from the digital world and reconnected with each other. The stargazing experience was absolutely magical.",
  ...
  },
  {
    ...
    rating: 5,
    quote: "As a solo traveler, I found exactly what I was looking for - peace, reflection, and incredible natural beauty. The meditation sessions were life-changing.",
  ...
  },
  {
    ...
    rating: 5,
    quote: "Our kids are still talking about the adventure weeks later! The perfect family bonding experience with activities for all ages. We'll definitely be back.",
  ...
  },
  {
    ...
    rating: 5,
    quote: "Every detail was thoughtfully planned. From the organic meals to the cozy accommodations, it exceeded all expectations. A true luxury in the wilderness.",
    experience: "Couple Retreat"
  }
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-16 py-12 border-t border-border/30">
          <blockquote className="text-2xl md:text-3xl font-playfair italic text-muted-foreground max-w-4xl mx-auto">
            ...
            Here, we simply help you find your natural rhythm."
          </blockquote>
          <cite className="text-primary font-medium mt-4 block">- Serenity Camp Philosophy</cite>
        </div>
      </div>
    </section>
  );
